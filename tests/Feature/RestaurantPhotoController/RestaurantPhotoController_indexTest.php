...
class RestaurantPhotoController_indexTest extends TestCase
{
    use RefreshDatabase;

    /**
     * Test the index method of RestaurantPhotoController.
     *
     * @return void
     */
    public function test_index_resource()
    {
        $response = $this->resource('restaurantPhoto/index');
