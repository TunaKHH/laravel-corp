                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @forelse ($users as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control user-remark" type="text"
                                                        name="user_remark[]" data-user_id="20" placeholder="此處備註">
                                                </td>
                                            </tr>
                                        @empty
                                            <p>沒有資料</p>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button"
                                                    class="btn btn-dark float-right save-confirm">儲存</button>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
