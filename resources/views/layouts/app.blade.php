    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="{{ url('/corp/logo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">YourCorp</span>
            </a>
        ...
        <footer class="main-footer">
            <strong>
                <!-- Copyright &copy; --> 2023 <a href="https://github.com/STUTuna/laravel-corp">鮪魚</a>.
            </strong>
            {{--        All rights reserved. --}}
